<?php 
define('CNF_APPNAME','Gestión Integral de Servicios');
define('CNF_APPDESC','CRM');
define('CNF_EMPID','1');//DE ACUERDO A BDD
define('CNF_COMNAME','APPgency');
